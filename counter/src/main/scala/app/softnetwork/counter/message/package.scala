...
import app.softnetwork.persistence.message.{CommandResult, CommandWrapper, Command}
...
package object message {
  ...
  case class CounterCommandWrapper(command: CounterCommand, replyTo: ActorRef[CounterResult])
    extends CommandWrapper[CounterCommand, CounterResult] with CounterCommand
