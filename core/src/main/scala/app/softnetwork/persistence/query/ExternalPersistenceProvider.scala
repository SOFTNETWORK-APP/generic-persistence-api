...
trait ExternalPersistenceProvider[T <: Timestamped] {_: ManifestWrapper[T] =>
  ...
  /**
    ...
    */
  def loadDocument(uuid: String)(implicit m: Manifest[T] = manifestWrapper.wrapped, formats: Formats): Option[T] = None
  ...
  /**
    ...
    */
  def searchDocuments(query: String)(implicit m: Manifest[T] = manifestWrapper.wrapped, formats: Formats): List[T] = List.empty
