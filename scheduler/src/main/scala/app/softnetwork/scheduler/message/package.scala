...
import app.softnetwork.persistence.message.{ErrorMessage, CommandResult, Command}
import app.softnetwork.scheduler.model.{SchedulerItem, CronTabItem}
...
package object message {
  ...
  trait SchedulerCommand extends Command
